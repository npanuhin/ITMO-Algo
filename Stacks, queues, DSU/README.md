...
Теперь опишем процесс подкладывания яйца в имеющиеся гнезда: пусть учёные хотят подложить яйцо $(x, y)$
в гнездо $x$. Если в гнезде $x$ нет яйца, то яйцо $(x, y)$ просто остаётся в этом гнезде, и процесс на данном шаге завершается. Если же в гнезде $x$ лежит какое-то яйцо $(x, p)$, то кукушка кладёт яйцо $(x, y)$ в данное гнездо, а яйцо $(x, p)$ пытается подложить в гнездо $p$ аналогичным образом, и процесс продолжается.
