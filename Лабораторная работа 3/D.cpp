...
signed main() {
    ...
    vector<int> tmp_v_int(10);
    vector<vector<int>> d(n, tmp_v_int);
    ...
    for (int i = 1; i < n; ++i) {
        for (int j = 0; j < 10; ++j) {
            switch (j) {
                case 0:
                    d[i][j] = d[i - 1][4] + d[i - 1][6];
                    break;
                case 1:
                    d[i][j] = d[i - 1][8] + d[i - 1][6];
                    break;
                case 2:
                    d[i][j] = d[i - 1][7] + d[i - 1][9];
                    break;
                case 3:
                    d[i][j] = d[i - 1][4] + d[i - 1][8];
                    break;
                case 4:
                    d[i][j] = (d[i - 1][3] + d[i - 1][9]) % MOD + d[i - 1][0];
                    break;
                case 5:
                    d[i][j] = 0;
                    break;
                case 6:
                    d[i][j] = (d[i - 1][1] + d[i - 1][7]) % MOD + d[i - 1][0];
                    break;
                case 7:
