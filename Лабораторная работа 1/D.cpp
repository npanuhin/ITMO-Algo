...
template <class T>
void siftDown(vector<T> &heap, int i) {
...
template <class T>
void siftUp(vector<T> &heap, int i) {
...
template <class T>
void insertHeap(vector<T> &heap, T a) {
    heap.push_back(a);
